...
public class PersonMapperTest {
    ...
    @Test
    public void selectPersonForGivenName1() throws Exception {
        Person o = personMapper.selectPersonForGivenName1("周杰伦");
        System.out.println(o.toString());
    }

    @Test
    public void selectPersonForGivenName2() throws Exception {
        Person o = personMapper.selectPersonForGivenName2("周杰伦");
        System.out.println(o.toString());
    }
